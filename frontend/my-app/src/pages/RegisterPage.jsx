  ...
  return (
    <div className="bg-surface font-inter text-on-surface min-h-screen flex flex-col">
      ...
      <footer className="w-full bg-surface-container-highest border-t border-outline-variant">
        <div className="w-full px-10 py-6 flex flex-col md:flex-row justify-between items-center max-w-container-max mx-auto gap-3">
          <div className="text-body-md text-on-surface">© 2024 MicroCred AI. Keandalan Institusional.</div>
          <div className="flex gap-6">
            <a className="text-on-surface-variant hover:text-secondary underline text-body-md" href="#">Kebijakan Privasi</a>
            <a className="text-on-surface-variant hover:text-secondary underline text-body-md" href="#">Syarat Layanan</a>
          </div>
        </div>
      </footer>
    </div>
