  ...
  return (
    <div className="bg-surface font-inter text-on-surface min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-[1000px] flex justify-start mb-6">
        <Link to="/" className="flex items-center gap-2 text-on-surface-variant hover:text-primary transition-colors group bg-surface-container-lowest px-5 py-2.5 rounded-full shadow-sm border border-outline-variant/30 hover:shadow-md">
          <span className="material-symbols-outlined text-[20px] group-hover:-translate-x-1 transition-transform">arrow_back</span>
          <span className="text-label-md font-medium">Kembali ke Beranda</span>
        </Link>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center">
                ...
                <Link className="text-label-sm text-secondary hover:underline" to="/forgot-password">Lupa kata sandi?</Link>
              </div>
